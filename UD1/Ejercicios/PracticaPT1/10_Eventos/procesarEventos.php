...
<body>
    <div class="contenedor">
        <h1>ORGANIZACIÓN DE EVENTOS - RESUMEN</h1>
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST" && $todoValido): ?>
            ...
            <p><strong>Menú:</strong> <?php echo htmlspecialchars($menu); ?></p>
            <p><strong>Número de Invitados:</strong> <?php echo $invitados; ?></p>
            ...
            <ul>
                ...
                <li><strong>Coste menú:</strong> <?php echo number_format($precioMenu, 2); ?> ¬ (<?php echo $precioBaseMenu; ?> ¬ × <?php echo $invitados; ?> × <?php echo $multiplicadorTemporada; ?>)</li>
            </ul>
            ...
            <ul>
                ...
                <li><strong>Menú:</strong> <?php echo number_format($precioMenu, 2); ?> ¬</li>
        ...
        <?php else: ?>
            <p>Por favor, envía el formulario de evento para generar el resumen.</p>
        <?php endif; ?>
    </div>
</body>
