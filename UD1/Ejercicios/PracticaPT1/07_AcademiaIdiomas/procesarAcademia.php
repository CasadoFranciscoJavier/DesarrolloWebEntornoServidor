...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($todoValido) {
        ...
        if (!empty($materialesSeleccionados) && is_array($materialesSeleccionados)) {
            ...
            $lista_materiales = "<p>No seleccionaste ningún material.</p>";
        }
...
<head>
    ...
    <title>Resumen de Matrícula - Academia</title>
</head>

<body>
    <div class="contenedor">
        <h1>ACADEMIA DE IDIOMAS - RESUMEN DE MATRÍCULA</h1>
        ...
        <?php else: ?>
            <p>Por favor, envía el formulario de matrícula para generar el resumen.</p>
        <?php endif; ?>
    </div>
</body>
