...
/**
 * Title: Related Post
 * Slug: cv-workfolio/related-post
 * Categories: cv-workfolio, related-post
 */
?>
...
<h4 class="wp-block-heading has-text-align-left"><strong><?php esc_html_e('Related Posts :-','cv-workfolio'); ?></strong></h4>
<!-- /wp:heading -->
