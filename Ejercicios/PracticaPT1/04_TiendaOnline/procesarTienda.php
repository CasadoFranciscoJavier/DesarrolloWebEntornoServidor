...
$nombres_productos = [
    ...
    "teclado_mecanico" => "Teclado Mecánico"
];

/**
 * Función para mostrar una alerta de JavaScript.
    ...
    if (!empty($productosSeleccionados)){
        ...
        foreach ($productosSeleccionados as $clave_producto) {
            ...
            if (isset($productos[$clave_producto])) { 
                ...
                // 3. OBTENER LA CANTIDAD. Esto YA NO FALLARÁ porque la clave es simple.
                ...
                // 4. Obtener el NOMBRE BONITO para la visualización y sanitizarlo
                ...
                $lista_productos .= "<li>$nombre_display × $cantidad = $precioTotal €</li>"; 
            }
        }
        $lista_productos .= "</ul>";
...
<body>
    <div class="contenedor">
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST"): ?>
            ...
            <p><strong><?php echo htmlspecialchars($envio); ?></strong> - <?php echo $precioEnvio; ?>€</p> 
...
<style>
    /* ... (El CSS se mantiene sin cambios ya que no tenía errores de codificación) ... */
    body {
        background: #f3f6f9;
